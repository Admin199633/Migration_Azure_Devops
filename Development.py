...
# כתובת ה-WIQL API
wiql_url = f"http://192.168.1.132/{organization}/{project}/_apis/wit/wiql?api-version=7.0-preview"
...
if response.status_code == 200:
    ...
    for item in work_items:
        ...
        work_item_url = f"http://192.168.1.132/{organization}/{project}/_apis/wit/workItems/{work_item_id}?$expand=relations&api-version=7.0"
