...
for item in work_items_data:
    ...
    patch_body = [
        {
            ...
            "value": {
                "rel": link_type,
                "url": f"http://192.168.1.132/{organization}/{project}/_apis/wit/workItems/{linked_item_id}",
                "attributes": {
    ...
    work_item_url = f"http://192.168.1.132/{organization}/{project}/_apis/wit/workItems/{work_item_id}?api-version=7.0"
