...
# URL בסיסי לשרת
base_url = "https://dev.azure.com/HMS-RD/Nativ-Clearance-API/_apis"
...
async def fetch_work_items():
    ...
    wiql_query = {
        "query": "SELECT [System.Id], [System.Title] FROM WorkItems WHERE [System.WorkItemType] = 'Bug' AND [System.AreaPath] = 'DG-Dev' AND [System.Id] > 7000 "
    }
