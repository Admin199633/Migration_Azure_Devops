...
url = "http://192.168.1.132/DefaultCollection/DG-Dev/_apis/wit/wiql?api-version=7.0"
...
if response.status_code == 200:
    ...
    for item in work_items:
        ...
        details_url = f"http://192.168.1.132/DefaultCollection/DG-Dev/_apis/wit/workitems/{work_item_id}?api-version=7.0"
