...
# כתובת ה-WIQL API
wiql_url = f"https://dev.azure.com/{organization}/{project}/_apis/wit/wiql?api-version=7.0-preview"

# כתובת ה-Work Item API
work_item_url_template = f"https://dev.azure.com/{organization}/_apis/wit/workitems/{{id}}?api-version=7.0-preview"
comments_url_template = f"https://dev.azure.com/{organization}/{project}/_apis/wit/workItems/{{id}}/comments?api-version=7.0-preview"
...
try:
    ...
    for work_item_id in work_item_ids:
        ...
        selected_fields.append({
            ...
            "Effort":fields.get("Microsoft.VSTS.Common.Effort", ""),
